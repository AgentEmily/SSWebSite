    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "1460903737528819",
               appSecret: "cf47b4595ce5b3a166c129d2f15dea2e");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "65356486906-ru3gs63h1ejbn33c07elbooj63futja2.apps.googleusercontent.com",
                ClientSecret = "I-ZsR01KCvyQoo9TlRwUwbr9"
            });
        }
    }
}