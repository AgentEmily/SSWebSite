...
namespace SStest
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            //這個方法有NULL webpage.dll 問題  先跳過
            //WebMail.SmtpPort = 465;
            //WebMail.SmtpServer = "smtp.gmail.com";
            //WebMail.UserName = "yinghua0111@gmail.com";
            //WebMail.Password = "emily75111";
            ...
            NetworkCredential loginInfo = new NetworkCredential("cecilia75111", "emily75111");
            mail.Credentials = loginInfo;
            

            MailMessage mms = new MailMessage();
            mms.From = new MailAddress("cecilia75111@gmail.com", "SmartShopping Crew");
            mms.To.Add(new MailAddress(message.Destination, "會員"));
            mms.Subject = message.Subject;
            mms.IsBodyHtml = true;
